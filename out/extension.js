...
// src/utils/ai-com.js
var require_ai_com = __commonJS({
  "src/utils/ai-com.js"(exports2, module2) {
    ...
    async function sendToAI2(func, controller) {
    ...
    function extractJSDocsFromAI2(str) {
      const regex = /\/\*\*.*\*\//smg;
    ...
    module2.exports = {
      sendToAI: sendToAI2,
      extractJSDocsFromAI: extractJSDocsFromAI2,
      pingAI
    };
  }
});
...
var require_healthcheck = __commonJS({
  "src/commands/healthcheck.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var { pingAI } = require_ai_com();
    var HealthCheckCommand2 = (context, ollama_status2) => {
      let healthcheck = vscode2.commands.registerCommand("simple-ollama.healthcheck", async function() {
        ollama_status2.text = "$(loading~spin) Ollama";
        ollama_status2.color = new vscode2.ThemeColor("statusBar.foreground");
        ollama_status2.show();
        await new Promise((resolve) => setTimeout(resolve, 1e3));
        const serverStatus = await pingAI();
        ollama_status2.tooltip = "Ollama server is ";
        if (serverStatus) {
          vscode2.commands.executeCommand("setContext", "simple-ollama.enabled", true);
          ollama_status2.text = "$(check) Ollama";
          ollama_status2.color = "green";
          ollama_status2.tooltip += "up and running";
        } else {
          vscode2.commands.executeCommand("setContext", "simple-ollama.enabled", false);
          ollama_status2.text = "$(close) Ollama";
          ollama_status2.color = "indianred";
          ollama_status2.tooltip += "down.";
          const userRes = await vscode2.window.showInformationMessage(
            "Ollama Server seems to be down. See Ollama Docs for details",
            "Ollama Docs"
          );
          if (userRes !== void 0) {
            vscode2.commands.executeCommand("vscode.open", vscode2.Uri.parse("https://github.com/ollama/ollama"));
          }
        }
      });
    ...
    module2.exports = {
      HealthCheckCommand: HealthCheckCommand2
    };
  }
});
...
var require_commands = __commonJS({
  "src/commands/index.js"(exports2, module2) {
    var { HealthCheckCommand: HealthCheckCommand2 } = require_healthcheck();
    module2.exports = {
      HealthCheckCommand: HealthCheckCommand2
    };
  }
...
var require_walk2 = __commonJS({
  "src/utils/walk.js"(exports2, module2) {
    var fs = require("fs");
    var acorn = require_acorn();
    var walk = require_walk();
    function extractFunctionsFromFile2(filePath) {
    ...
    module2.exports = {
      extractFunctionsFromFile: extractFunctionsFromFile2
    };
  }
});
...
var { HealthCheckCommand } = require_commands();
var { sendToAI, extractJSDocsFromAI } = require_ai_com();
var { extractFunctionsFromFile } = require_walk2();
var ollama_status;
